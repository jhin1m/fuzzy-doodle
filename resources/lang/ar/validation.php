...
return [
  ...
  "ascii" =>
    "يجب أن يحتوي الحقل :attribute فقط على أحرف أبجدية رقمية أحادية البايت ورموز.",
  ...
  "doesnt_end_with" =>
    "الحقل :attribute يجب ألّا ينتهي بأحد القيم التالية: :values.",
  "doesnt_start_with" =>
    "الحقل :attribute يجب ألّا يبدأ بأحد القيم التالية: :values.",
  ...
  "missing_if" =>
    "يجب أن يكون الحقل :attribute مفقوداً عندما :other يساوي :value.",
  "missing_unless" =>
    "يجب أن يكون الحقل :attribute مفقوداً ما لم يكن :other يساوي :value.",
  "missing_with" => "يجب أن يكون الحقل :attribute مفقوداً عند توفر :values.",
  "missing_with_all" =>
    "يجب أن يكون الحقل :attribute مفقوداً عند توفر :values.",
  ...
  "password" => [
    ...
    "uncompromised" =>
      "حقل :attribute ظهر في بيانات مُسربة. الرجاء اختيار :attribute مختلف.",
  ],
  ...
  "required_array_keys" =>
    "الحقل :attribute يجب أن يحتوي على مدخلات لـ: :values.",
  "required_if" =>
