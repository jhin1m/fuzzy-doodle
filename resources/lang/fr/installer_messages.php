...
return [
  ...
  "environment" => [
    "menu" => [
      ...
      "desc" =>
        "Veuillez sélectionner comment vous souhaitez configurer les applications <code>.env</code> file.",
      "wizard-button" => 'Configuration de l\'assistant de formulaire',
      "classic-button" => "Éditeur de texte classique",
    ],
    "wizard" => [
      "templateTitle" =>
        'Étape 3 | Paramètres d\'environnement | Assistant guidé',
    ...
    "classic" => [
      "templateTitle" =>
        'Étape 3 | Paramètres d\'environnement | Editeur Classique',
    ...
    "errors" =>
      "Impossible de sauvegarder le fichier .env, veuillez le créer manuellement.",
  ],
  ...
  "updater" => [
    ...
    "log" => [
      "success_message" =>
        'L\'installateur Laravel a été mis à jour avec succès le ',
    ],
  ],
];
