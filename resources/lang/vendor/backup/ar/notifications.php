...
return [
  ...
  "cleanup_failed_subject" =>
    "فشل تنظيف النسخ الاحتياطي للتطبيق :application_name .",
  "cleanup_failed_body" =>
    "حدث خطأ أثناء تنظيف النسخ الاحتياطية ل :application_name",

  "cleanup_successful_subject" =>
    "تنظيف النسخ الاحتياطية ل :application_name تمت بنجاح",
  ...
  "healthy_backup_found_subject_title" =>
    "النسخ الاحتياطية ل :application_name صحية",
  ...
  "unhealthy_backup_found_not_reachable" =>
    "لا يمكن الوصول إلى وجهة النسخ الاحتياطي. :error",
  "unhealthy_backup_found_empty" =>
    "لا توجد نسخ احتياطية لهذا التطبيق على الإطلاق.",
  "unhealthy_backup_found_old" =>
    "تم إنشاء أحدث النسخ الاحتياطية في :date وتعتبر قديمة جدا.",
