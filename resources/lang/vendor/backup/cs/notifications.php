...
return [
  ...
  "backup_failed_body" =>
    "Důležité: Při záloze :application_name se vyskytla chyba",
  ...
  "cleanup_failed_body" =>
    "Při čištění záloh :application_name se vyskytla chyba",
  ...
  "cleanup_successful_body" =>
    "Vyčištění záloh :application_name na disku jménem :disk_name bylo úspěšné.",

  "healthy_backup_found_subject" =>
    "Zálohy pro :application_name na disku :disk_name jsou zdravé",
  "healthy_backup_found_subject_title" =>
    "Zálohy pro :application_name jsou zdravé",
  "healthy_backup_found_body" =>
    "Zálohy pro :application_name jsou považovány za zdravé. Dobrá práce!",

  "unhealthy_backup_found_subject" =>
    "Důležité: Zálohy pro :application_name jsou nezdravé",
  ...
  "unhealthy_backup_found_not_reachable" =>
    "Nelze se dostat k cíli zálohy. :error",
  "unhealthy_backup_found_empty" => "Tato aplikace nemá vůbec žádné zálohy.",
  "unhealthy_backup_found_old" =>
    "Poslední záloha vytvořená dne :date je považována za příliš starou.",
  "unhealthy_backup_found_unknown" =>
    "Omlouváme se, nemůžeme určit přesný důvod.",
