...
return [
  ...
  "backup_failed_body" =>
    "חשוב: אירעה שגיאה במהלך גיבוי היישום :application_name",
  ...
  "cleanup_failed_body" =>
    "אירעה שגיאה במהלך ניקוי הגיבויים של :application_name",

  "cleanup_successful_subject" =>
    "ניקוי הגיבויים של :application_name בוצע בהצלחה",
  "cleanup_successful_subject_title" => "ניקוי הגיבויים בוצע בהצלחה!",
  "cleanup_successful_body" =>
    "ניקוי הגיבויים של :application_name על הדיסק בשם :disk_name בוצע בהצלחה.",

  "healthy_backup_found_subject" =>
    "הגיבויים של :application_name על הדיסק :disk_name תקינים",
  "healthy_backup_found_subject_title" =>
    "הגיבויים של :application_name תקינים",
  "healthy_backup_found_body" =>
    "הגיבויים של :application_name נחשבים לתקינים. עבודה טובה!",

  "unhealthy_backup_found_subject" =>
    "חשוב: הגיבויים של :application_name אינם תקינים",
  "unhealthy_backup_found_subject_title" =>
    "חשוב: הגיבויים של :application_name אינם תקינים. :problem",
  "unhealthy_backup_found_body" =>
    "הגיבויים של :application_name על הדיסק :disk_name אינם תקינים.",
  ...
  "unhealthy_backup_found_old" =>
    "הגיבוי האחרון שנעשה בתאריך :date נחשב כישן מדי.",
