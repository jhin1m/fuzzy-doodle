...
return [
  ...
  "backup_failed_body" =>
    "जरूरी सुचना: :application_name का बैकअप लेते समय असफल रहे",
  ...
  "backup_successful_body" =>
    "खुशखबर, :application_name का बैकअप :disk_name पर संग्रहित करने मे सफल रहे.",

  "cleanup_failed_subject" => ":application_name के बैकअप की सफाई असफल रही.",
  "cleanup_failed_body" =>
    ":application_name के बैकअप की सफाई करते समय कुछ बाधा आयी है.",
  ...
  "healthy_backup_found_subject_title" =>
    ":application_name के सभी बैकअप स्वस्थ है",
  "healthy_backup_found_body" =>
    "बहुत बढ़िया! :application_name के सभी बैकअप स्वस्थ है.",

  "unhealthy_backup_found_subject" =>
    "जरूरी सुचना :  :application_name के बैकअप अस्वस्थ है",
  ...
  "unhealthy_backup_found_not_reachable" =>
    ":error के बजेसे बैकअप की मंजिल तक पोहोच नहीं सकते.",
  "unhealthy_backup_found_empty" => "इस एप्लीकेशन का कोई भी बैकअप नहीं है.",
  "unhealthy_backup_found_old" =>
    "हालहीमें :date को लिया हुआ बैकअप बहुत पुराना है.",
  "unhealthy_backup_found_unknown" =>
    "माफ़ कीजिये, सही कारण निर्धारित नहीं कर सकते.",
