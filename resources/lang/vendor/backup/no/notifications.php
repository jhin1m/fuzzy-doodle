...
return [
  ...
  "cleanup_failed_subject" =>
    "Opprydding av backup for :application_name feilet.",
  "cleanup_failed_body" =>
    "En feil oppstod under opprydding av backups for :application_name",

  "cleanup_successful_subject" =>
    "Opprydding av backup for :application_name gjennomført",
  ...
  "healthy_backup_found_body" =>
    "Alle backups for :application_name er ok. Godt jobba!",

  "unhealthy_backup_found_subject" =>
    "Viktig: Backups for :application_name ikke OK",
  "unhealthy_backup_found_subject_title" =>
    "Viktig: Backups for :application_name er ikke OK. :problem",
  "unhealthy_backup_found_body" =>
    "Backups for :application_name på disken :disk_name er ikke OK.",
  "unhealthy_backup_found_not_reachable" =>
    "Kunne ikke finne backup-destinasjonen. :error",
  ...
  "unhealthy_backup_found_unknown" =>
    "Beklager, kunne ikke finne nøyaktig årsak.",
