...
return [
  ...
  "backup_successful_body" =>
    "好消息, :application_name 备份成功，位于磁盘 :disk_name 中。",
  ...
  "cleanup_successful_body" =>
    "成功清除 :disk_name 磁盘上 :application_name 的备份。",

  "healthy_backup_found_subject" =>
    ":disk_name 磁盘上 :application_name 的备份是健康的",
  ...
  "unhealthy_backup_found_subject" =>
    "重要说明：:application_name 的备份不健康",
  "unhealthy_backup_found_subject_title" =>
    "重要说明：:application_name 备份不健康。 :problem",
  "unhealthy_backup_found_body" =>
    ":disk_name 磁盘上 :application_name 的备份不健康。",
