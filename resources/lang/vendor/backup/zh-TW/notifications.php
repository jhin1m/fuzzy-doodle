...
return [
  ...
  "backup_successful_body" =>
    "好消息, :application_name 備份成功，位於磁碟 :disk_name 中。",
  ...
  "cleanup_successful_body" =>
    "成功清除 :disk_name 磁碟上 :application_name 的備份。",

  "healthy_backup_found_subject" =>
    ":disk_name 磁碟上 :application_name 的備份是健康的",
  ...
  "unhealthy_backup_found_subject" =>
    "重要說明：:application_name 的備份不健康",
  "unhealthy_backup_found_subject_title" =>
    "重要說明：:application_name 備份不健康。 :problem",
  "unhealthy_backup_found_body" =>
    ":disk_name 磁碟上 :application_name 的備份不健康。",
