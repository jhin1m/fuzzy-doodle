      ...
      <div class="tab" id="tab1content">
        ...
        <div class="form-group {{ $errors->has('environment') ? ' has-error ' : '' }}">
          ...
          <select name="environment" id="environment" onchange='checkEnvironment(this.value);'>
            ...
            <option value="development">
              {{ trans('installer_messages.environment.wizard.form.app_environment_label_developement') }}</option>
            <option value="qa">{{ trans('installer_messages.environment.wizard.form.app_environment_label_qa') }}
            </option>
            <option value="production">
              {{ trans('installer_messages.environment.wizard.form.app_environment_label_production') }}</option>
            <option value="other">{{ trans('installer_messages.environment.wizard.form.app_environment_label_other') }}
            </option>
          </select>
        ...
        <div class="form-group {{ $errors->has('app_log_level') ? ' has-error ' : '' }}">
          ...
          <select name="app_log_level" id="app_log_level">
            ...
            <option value="info">{{ trans('installer_messages.environment.wizard.form.app_log_level_label_info') }}
            </option>
            <option value="notice">{{ trans('installer_messages.environment.wizard.form.app_log_level_label_notice') }}
            </option>
            <option value="warning">{{ trans('installer_messages.environment.wizard.form.app_log_level_label_warning') }}
            </option>
            <option value="error">{{ trans('installer_messages.environment.wizard.form.app_log_level_label_error') }}
            </option>
            <option value="critical">
              {{ trans('installer_messages.environment.wizard.form.app_log_level_label_critical') }}</option>
            <option value="alert">{{ trans('installer_messages.environment.wizard.form.app_log_level_label_alert') }}
            </option>
            <option value="emergency">
              {{ trans('installer_messages.environment.wizard.form.app_log_level_label_emergency') }}</option>
          </select>
      ...
      <div class="tab" id="tab2content">
        ...
        <div class="form-group {{ $errors->has('database_connection') ? ' has-error ' : '' }}">
          ...
          <select name="database_connection" id="database_connection">
            ...
            <option value="sqlite">{{ trans('installer_messages.environment.wizard.form.db_connection_label_sqlite') }}
            </option>
            <option value="pgsql">{{ trans('installer_messages.environment.wizard.form.db_connection_label_pgsql') }}
            </option>
            <option value="sqlsrv">{{ trans('installer_messages.environment.wizard.form.db_connection_label_sqlsrv') }}
            </option>
          </select>
      ...
      @php
        ...
        <div class="tab" id="tab4content">
            <div class="form-group {{ $errors->has('admin_email') ? ' has-error ' : '' }}">
                ...
                <input type="text" name="admin_email" id="admin_email" value="" placeholder="{{ __('Admin Email') }}" />
...
@endif
            ...
            <div class="form-group {{ $errors->has('admin_password') ? ' has-error ' : '' }}">
                ...
                <input type="password" name="admin_password" id="admin_password" value="" placeholder="{{ __('Admin Password') }}" />
