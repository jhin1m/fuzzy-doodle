...
Route::group(["middleware" => config("fortify.middleware", ["web"])], function () {
  ...
  Route::post(RoutePath::for("login", "/login"), [AuthenticatedSessionController::class, "store"])->middleware(
  ...
  if (Features::enabled(Features::registration())) {
    ...
    Route::post(RoutePath::for("register", "/register"), [RegisteredUserController::class, "store"])->middleware([
  ...
  if ($enableViews) {
    Route::get(RoutePath::for("password.confirm", "/user/confirm-password"), [ConfirmablePasswordController::class, "show"])->middleware([
      config("fortify.auth_middleware", "auth") . ":" . config("fortify.guard"),
    ]);
  }
