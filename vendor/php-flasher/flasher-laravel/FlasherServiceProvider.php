...
final class FlasherServiceProvider extends ServiceProvider
{
  ...
  private function registerBladeDirective()
  {
    Blade::extend(function ($view) {
      ...
      @trigger_error(
        "Since php-flasher/flasher-laravel v1.6.0: Using @flasher_render or @flasher_livewire_render is deprecated and will be removed in v2.0. PHPFlasher will render notification automatically",
        \E_USER_DEPRECATED
      );
